...
class Registration extends Model
{
    ...
    protected $fillable = [
        'user_id', 'registration_number', 'full_name',
        'student_name', 'nisn', 'nik', 'birth_place', 'birth_date', 'gender',
        'agama', 'kebutuhan_khusus', 'email',
        'address', 'rt', 'rw', 'nama_dusun', 'nama_kelurahan', 'kecamatan', 'kode_pos',
        'tinggal_bersama', 'transportasi', 'phone',
        'previous_school', 'academic_year', 'wave', 'major_choice',
        ...
        'mempunyai_wali', 'nama_wali', 'tahun_lahir_wali', 'pendidikan_wali', 'pekerjaan_wali', 'penghasilan_wali',
